...
def get_dataset(data_path, module_name, transform, dataset_args):
    ...
    #                 ICDAR2015Dataset(transform=transform, data_path=data_path,**dataset_args)
...
def get_dataloader(module_config, distributed=False):
    ...
    print("datasets:",dataset_args)
    if 'transforms' in dataset_args:
        img_transfroms = get_transforms(dataset_args.pop('transforms'))
    else:
        img_transfroms = None
    # 创建数据集
    dataset_name = config['dataset']['type'] # ICDAR2015Dataset
    data_path = dataset_args.pop('data_path') # ['/home/share/gaoluoluo/dbnet/datasets/train_zhen.txt']
    if data_path == None:
        return None
    ...
    # print("data_path:",data_path) ['/home/share/gaoluoluo/dbnet/datasets/train_zhen.txt']
    if len(data_path) == 0:
        return None
